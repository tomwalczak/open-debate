...
export function JudgeVerdict({ verdict, topicNumber, speaker1Id, speaker2Id, speaker1Name, speaker2Name }: JudgeVerdictProps) {
  ...
  return (
    <Box flexDirection="column" borderStyle="round" borderColor="yellow" paddingX={1} marginY={1}>
      <Text bold color="yellow">
        {topicNumber !== undefined ? `Topic ${topicNumber} Verdict` : "Judge's Verdict"}
      </Text>
      <Box marginTop={1}>
        <Text>
